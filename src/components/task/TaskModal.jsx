  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white rounded-lg p-6 w-[90vw] md:w-[50vw] max-w-lg">
        ...
        <p className="mb-2"><strong>Task Number:</strong> {task.taskNo}</p>
        ...
        <p className="mb-4"><strong>Submission Date:</strong> {task.submissionDate}</p>
        <p className="mb-4"><strong>Remarks:</strong> {task.remarks}</p>
